...
class PlayerModule {
    ...
    async init() {
        console.log('qwe');
        this.player = await this.createPlayer(); // теперь createPlayer может быть асинхронной
...
//TODO добавить пушку
    ...
    checkCollision(bulletElement) {
        const objectElement = document.getElementById(object2.countObj); // Замените 'object' на id вашего объекта
    ...
    trigger() {
        ...
        document.getElementById(object2.countObj).remove()
        object2.clearInter()
    }
}
